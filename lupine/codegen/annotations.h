...
/**
 * @disabled client - manual client keeps capture policy in application TLS
 * @param mode SEND_RECV
 */
 ...
 * @param stream SEND_ONLY
 * @param count SEND_ONLY
 * @param paramArray SEND_RECV LENGTH:count
 * @param flags SEND_ONLY
 */
...
/**
 * @disabled client - manual client supports asynchronous launch with a synchronous fallback
 * @param hGraphExec SEND_ONLY
 * @param hStream SEND_ONLY
 */
